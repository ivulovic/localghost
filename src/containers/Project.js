...
export class Project extends React.Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      project: {
        ...
        tasks:[
          {id:1, categories:[{id:1, name:'important'}], status:'start',    project:"Projects 1",
          ...
          {id:12, categories:[{id:2, name:'overdue'}], status:'start',    project:"Projects 1",
            assigner: {id:33232121, avatar:'https://material-ui.com/static/images/avatar/1.jpg'},
            assignee:  {id:132321, avatar:'https://material-ui.com/static/images/avatar/2.jpg'},
            title: "Simple title and simple description", description:"This is some dumb description",
            notes:[
          ...
          {id:6, categories:[], status:'start',    project:"Projects 5",
          ...
          {id:3, categories:[{id:3, name:'bookmark'}], status:'done',    project:"Projects 3",
          ...
          {id:4, categories:[{id:4, name:'observe'}], status:'start',    project:"Projects 4",
          ...
          {id:5, categories:[{id:4, name:'observe'},{id:5, name:'snooze'},{id:6, name:'archive'}], status:'start',    project:"Projects 5",
            assigner: {id:12131311, avatar:'https://material-ui.com/static/images/avatar/7.jpg'},
            assignee:  {id:12323331, avatar:'https://material-ui.com/static/images/avatar/4.jpg'},
            title: "Add UglifyJS when compiling to production", description:"Range pickers pdf",
            notes:[
  ...
  dataWithFiltersApplied = () => {
    ...
    return this.state.project.tasks.filter(item => statusFilters.length ? statusFilters.indexOf(item.status) >= 0 : item)
      .filter(item => {
